...
/**
 * Normalisasi daftar role: buang non-string, trim, dan lowercase.
 * Dipakai agar perbandingan role tahan terhadap spasi / perbedaan huruf besar-kecil.
...
function hasRole(req, allowedRoles) {
    const roles = normalizeRoles(getUserRolesFromRequest(req));
