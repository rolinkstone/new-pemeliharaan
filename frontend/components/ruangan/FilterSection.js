...
const FilterSection = ({ filters, onFilterChange }) => {
  ...
  // Debounce: terapkan pencarian otomatis 400ms setelah berhenti mengetik
  useEffect(() => {
    const timer = setTimeout(() => {
      const next = localFilters.search || '';
      if (next !== (filters.search || '')) {
        onFilterChange({ ...localFilters, search: next });
      }
    }, 400);
      ...
      <Grid container spacing={2} alignItems="center">
        ...
        <Grid item xs={12} md={6}>
          <TextField
            ...
            size="small"
            label="Cari Ruangan"
            placeholder="Ketik kode, nama, deskripsi, atau lokasi..."
